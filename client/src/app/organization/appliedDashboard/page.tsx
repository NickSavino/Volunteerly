...
export default function HomePage() {
  const {loading, session, router, signOut, user, error, currentUser} = useAppliedOrgDashboardViewModel()
    ...
    <div className="min-h-screen">
        ...
        <main className="flex flex-col md:flex-row md:h-[calc(100vh-64px)] p-6 ">
            ...
            <div className="w-full mb-5 md:mb-0 md:w-2/3 mx-auto max-w-3x1 flex flex-col min-h-full gap-6">
                <div className="flex flex-col justify-center h-full text-center justify-center">
            ...
            <div className="w-full md:w-1/3 mx-auto max-w-3xl space-y-6 min-h-full">
                <Card className="mx-5">
                    ...
                    <CardContent>
                        <Button variant="ghost" className="text-lg py-6 cursor-pointer flex gap-3 cursor-pointer" onClick={async () => { router.push("/organization/application"); }}>
