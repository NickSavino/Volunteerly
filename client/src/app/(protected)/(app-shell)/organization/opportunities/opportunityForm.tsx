...
export default function OpportunityForm({ opportunity, editing ,handleSubmit, setOpportunity, deadlineDate, handleDayToggle, setDeadlineDate}: OpportunityFormProps) {
