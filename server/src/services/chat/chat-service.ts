...
import { chatConversationDetailArgs, ChatConversationDetailRecord, chatConversationListArgs, ChatConversationListRecord, ChatMessageRecord, chatMessageWithSenderArgs } from "./chat.queries.js";
...
export async function getChatConversationList(userId: string): Promise<ChatConversationList> {
    const conversations: ChatConversationListRecord[] =
...
export async function getChatConversationDetail(userId: string, conversationId: string): Promise<ChatConversationDetail | null> {
...
export async function createChatMessage(userId: string, conversationId: string, content: string): Promise<ChatMessage | null> {
